...
public class Midterm {
	public static void main(String[] args) {
		Student stud1 = new Student("20212091","홍길동",3);
		//stud1.exam[0].setExamScore("자바",88);
		//stud1.exam[1].setExamScore("C",90);
		//stud1.exam[2].setExamScore("C++",100);
...
class Student {
	...
	public void printGPA() {
		for(int i =0; i<exam.length; i++) {
			System.out.println("과목명:"+this.exam[i].getSubject()+
					",점수="+this.exam[i].getScore());
		}
